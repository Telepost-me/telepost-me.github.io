---
sidebar_position: 2
description: For correct work is best to use a new bot in Telepost, which is not connected with other services
tags:
  - Guide
  - Start
  - Bot
...
The article will discuss how to connect your bot to Telepost.
...
Go to [{{ telepost.bot.name }}]({{ telepost.bot.url }}) and send the command `/addbot`:

![image](/images/106514765-bc0a1d80-64e5-11eb-82e4-c33a541f3037.png)

Forward to [{{ telepost.bot.name }}]({{ telepost.bot.url }}) token, which your get from [@BotFather](https://t.me/BotFather):

![image](/images/106514986-0be8e480-64e6-11eb-98b9-b777d17896f1.png)

## Done

The bot was created and added to Telepost. Now add this bot to the admins of the channel where you want to publish posts. See [step #2 here](getting-started.mdx) for how to do this.
