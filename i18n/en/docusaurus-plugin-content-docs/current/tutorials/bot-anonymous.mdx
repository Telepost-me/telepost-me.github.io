...
If you need to remove this caption in the chat, you must turn it off in the channel settings:

* Channel → Information → Caption messages (turn it off)
* Channel → Information → Show author profiles (turn it off)

After that, the caption will disappear both in the channel and in the connected chat (you cannot turn it off only in one place — this is how Telegram works 🤷‍♂️).
