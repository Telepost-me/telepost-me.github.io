---
description: How to make text/media spoiler in Native mode, Markdown, HTML
tags:
  - Tutorial
  - Post
  - Text
...
* **[Native](native-mode.mdx)** — just select the text/media and choose <kbd>Format</kbd> → <kbd>Spoiler</kbd> from the pop-up menu:
