---
sidebar_position: 8
description: Republishing a post at regular intervals
tags:
  - Tutorial
  - Post
  - Web UI
...
**Attention:** the function is available only in the [Web UI]({{ telepost.webApp.url }}) (via the [bot]({{ telepost.bot.url }}) you cannot, but [wish already exist](https://github.com/Telepost-me/support/issues/39))!
