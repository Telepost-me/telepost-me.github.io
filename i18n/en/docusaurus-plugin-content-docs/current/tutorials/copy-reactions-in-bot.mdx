---
sidebar_position: 11
description: Now you don't have to bother copying reactions
tags:
  - Tutorial
  - Reactions
  - Bot
...
A command has been added to the bot extra-keyboard [{{ telepost.bot.name }}]({{ telepost.bot.url }}), with which you can easily copy and paste buttons / reactions into your posts.

To use this function:

* Go to [{{ telepost.bot.name }}]({{ telepost.bot.url }}) and start creating a new post as usual
...
![image](/images/127932584-6f7766ea-6812-490a-b201-b2532f36d24b.png)
