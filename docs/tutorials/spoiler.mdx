---
description: Как сделать текст/медия скрытым в формате Native, Markdown, HTML
tags:
  - Туториал
  - Пост
  - Текст
...
* **[Native](native-mode.mdx)** — просто выделите текст/медиа и во всплывающем меню выберите <kbd>Форматирование</kbd> → <kbd>Скрытый</kbd>:

  ![image](/images/220902300-12d4e906-9a61-46e1-8351-dc9e933a4dab.jpg)

  ![image](/images/220902421-bbe8b785-1f02-439e-a366-d03f1cb672b4.jpg)
...
* в **обычном режиме редактора** — выделите текст и отформатируете как на скриншоте ниже:
  ...
  ![image](/images/220900766-1d10c6f4-1255-42da-b95f-5c6e93044d7f.png)

  Текст будет виден, но подсвечиваться желтым цветом:

  ![image](/images/220914642-03e7e20c-d612-4e1b-af6d-d295ba899058.png)

* в **режиме редактора Markdown** — оберните в парные символы `||`:

  ![image](/images/220951037-e234d0e3-e478-4e90-9c6d-46b0017e8bfb.png)
